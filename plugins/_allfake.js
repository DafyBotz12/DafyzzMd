...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '@s.whatsapp.net'), ' ', 'reybotz104@gmail.com', true],
         [owner[1], await conn.getName(owner[1] + '@s.whatsapp.net'), ' ', 'reybotz104@gmail.com', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					body: wm,
					mediaUrl: sgc,
					description: 'Dafyzz-MultiDevice',
					previewType: "PHOTO",
...
global.fakefb = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            ...
            mediaType: "VIDEO",
            description: "https://www.Facebook.com/RaihanKhadafy", 
            title: 'Dafyz-MultiDevice',
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
    }
        ...
        global.fvn = {
            ...
            message: { "liveLocationMessage": { "caption":"by : Dafyzz-Md","h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "Dafyzz-Md","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
